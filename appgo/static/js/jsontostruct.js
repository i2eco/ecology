$(function()
{
    const emptyInputMsg = "请在这里输入Json";
    const emptyOutputMsg = "这里会展示GO的结构体";
    ...
    $('#copy-btn-inline').click(function()
    {
        $('#inline').prop("checked","checked");
        $('#input').text(stringify(sampleJson1)).keyup();
    });
    $('#copy-btn-outline').click(function()
    {
